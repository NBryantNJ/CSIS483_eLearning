...
function checkDataFormatting() {
    ...
    //Check firstname
    if ($(".inputFirstName").val().length < 2 || $(".inputFirstName").val().length > 12) {
        $(".inputFirstName").css("border-color", "red");
        isFormattingCorrect = false; 
        errors += "<p><span>*</span>First name must be from 2 - 12 characters.</p>"; 
    }
    else {
        var reg = /^[a-z]+$/i;
    ...
    //Check lastname
    if ($(".inputLastName").val().length < 2 || $(".inputLastName").val().length > 12 ) {
        $(".inputLastName").css("border-color", "red");
        isFormattingCorrect = false;
        errors += "<p><span>*</span>Lastname must be from 2 - 12 characters.</p>"; 
    }
    else {
        var reg = /^[a-z]+$/i;
    ...
    //Check email
    if ($(".inputEmail").val().length < 7 || $(".inputEmail").val().length > 35) {
    ...
    //check username
    if ($(".inputUsername").val().length < 5 || $(".inputUsername").val().length > 12) {
        $(".inputUsername").css("border-color", "red");
        isFormattingCorrect = false;
        errors += "<p><span>*</span>Username must be from 5 - 12 characters.</p>";
    }
    else {
        var reg = /[a-zA-Z1-9]/;
    ...
    //check password
    if ($(".inputPassword").val().length < 5 || $(".inputPassword").val().length > 12) {
        $(".inputPassword").css("border-color", "red");
        isFormattingCorrect = false;
        errors += "<p><span>*</span>Password must be from 5 - 12 characters.</p>";
    }
    else {
